 ...
 * Use the {@link VuFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class VuFragment extends Fragment implements VuAdapter.callback {
    ...
    public static VuFragment newInstance(String param1, String param2) {
        VuFragment fragment = new VuFragment();
    ...
    private void instantiateRecycler(View v){
        ...
        setRecyclerItems();
        this.adapter = new VuAdapter(getActivity(), recyclerItemsList, this);
    ...
    private void setRecyclerItems(){
        ...
        DataShared.getInstance().getStatusList(getActivity(), FilmizStatus.VU);
