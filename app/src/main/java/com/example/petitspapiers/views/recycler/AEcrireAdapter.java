...
public class AEcrireAdapter extends RecyclerView.Adapter<ViewholderForRecycler> {
    ...
    public AEcrireAdapter(Context context, List<RecyclerItems> items, callback listener) {
    ...
    private void setListeners(ViewholderForRecycler holder){
        ...
        holder.vu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                filmiz.setStatus(FilmizStatus.AVOIR);
